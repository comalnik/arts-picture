  ...
  try {
    ...
    while (!pixelTurnedBlack) {
      ...
      if (!(pixel[0] === 0 && pixel[1] === 0 && pixel[2] === 0)) {
        ...
        image.setPixelXY(x, y, [0, 0, 0, pixel[3] || 255]); // Preserve alpha channel
    ...
    console.log('Random pixel turned black.');
  } catch (error) {
    console.error('Error turning random pixel black:', error);
  }
}
